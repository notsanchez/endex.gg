...
const HomeHeader = () => {
  ...
  return (
    <div className='w-[90%] lg:w-[70%] flex items-center justify-center py-24 mb-6 px-8 lg:px-0 bg-[#8234E9] rounded-xl mt-32'>
        <div className='flex flex-col items-center justify-center gap-4'>
          ...
          }} color='primary' className='text-white rounded-full mt-4 font-bold border-1 border-white'>Ver categorias</Button>
        </div>
    </div>
  )
}
